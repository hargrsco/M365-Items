<#  
********************************************************************************************************
ListStaleDevices.ps1:  This script will detect the appropriate cloud environment endpoint in Entra ID

Usage:
======
.\ListStaleDevices.ps1
        
Output:
=======
The script will a list of devices that have not synched in over x months. For example, if you enter 3, 
